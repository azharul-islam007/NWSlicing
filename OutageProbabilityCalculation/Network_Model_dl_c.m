classdef Network_Model_dl_c < Network_Model_c
    ...
    methods
        function self = Network_Model_dl_c(M_eMBB_i, M_veh_i, M_mMTC_i, lambda_e_i, sim_nr_drops_per_round_i, sim_nr_round_i)
            ...
            self.avg_prb_utilization_ratio_v2x = zeros(self.sim_nr_round, 1);
            self.avg_prb_utilization_ratio_eMBB = zeros(self.sim_nr_round, 1);
            self.avg_prb_utilization_ratio_mMTC = zeros(self.sim_nr_round, 1);
        ...
        function [pd_v2x_SINR_dB_o, pd_v2x_Nr_packet_o, ...
            ...
            sinr_dB = cell2vec_f(self.nw_characteristics_v2x.SINRdB);
            pd_v2x_SINR_dB_o = fitdist(sinr_dB, 'Normal'); 
            nr_packets = cell2vec_f(self.nw_characteristics_v2x.nr_packets);            
