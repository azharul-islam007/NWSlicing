classdef Constants_c < handle
    properties (Constant)
        ...
        ignore_online_nw_characteristics = true;
    ...
    methods(Static)
        function [] = print_configurations()
            fprintf(1, '---------------Configurations:------------------ \n');
            fprintf(1, 'ignore_online_nw_characteristics = %s\n', string(Constants_c.ignore_online_nw_characteristics));
            fprintf(1, 'M_veh = %d\n', Constants_c.M_veh); 
            fprintf(1, 'lambda_niu = %f\n', Constants_c.lambda_niu);    
            fprintf(1, 'M_eMBB = %d\n', Constants_c.M_eMBB);         
            fprintf(1, 'M_mMTC = %d\n', Constants_c.M_mMTC); 
            fprintf(1, 'p_mMTC_tx = %f\n', Constants_c.p_mMTC_tx);  
            fprintf(1, 'max_mMTC_packet_size = %d\n', Constants_c.max_mMTC_packet_size);        
            fprintf(1, 'sim_nr_drops_per_round per round = %d\n', Constants_c.sim_nr_drops_per_round); 
            fprintf(1, 'sim_nr_round = %d\n', Constants_c.sim_nr_round); 
            fprintf(1, '------------------------------------------------ \n');
        end
    end
