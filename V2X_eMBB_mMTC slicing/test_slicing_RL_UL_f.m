...
% The number of vehicular UEs working under cellular mode in the four
% cluster in the off-line network model. It should be tuned according to
% the configuration of online network model (which could be simulated or
% could be in a field network)
V_v2x_UL = [1 2 3 4];

% The number of vehicular UEs working under sidelink mode in the four
% cluster in the off-line network model. It should be tuned according to
% the configuration of online network model (which could be simulated or
% could be in a field network)
V_v2x_SL = [5 6 7 8];
...
slicing_RL_UL_f(rand_seed, nr_episode, tao, Avg_T, V_v2x_UL, V_v2x_SL, M_eMBB, M_mMTC);
